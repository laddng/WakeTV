...
#import "WTVmoviesViewController.h"
#import "WTVChannel.h"
#import "WTVsubViewController.h"

@interface WTVmoviesViewController ()

@property NSMutableArray *channelguide;

@end

@implementation WTVmoviesViewController
...
- (void)loadInitialData {
    ...
    for (int i=0; i<[lines count]; i++) {
        ...
        if ([[lineItem objectAtIndex:0] isEqualToString:@"4"]) {
