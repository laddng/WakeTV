...
#import "WTVnewsViewController.h"
#import "WTVChannel.h"
#import "WTVsubViewController.h"

@interface WTVnewsViewController ()

@property NSMutableArray *channelguide;

@end

@implementation WTVnewsViewController
...
- (void)loadInitialData {
    ...
    for (int i=0; i<[lines count]; i++) {
        ...
        if ([[lineItem objectAtIndex:0] isEqualToString:@"2"]) {
